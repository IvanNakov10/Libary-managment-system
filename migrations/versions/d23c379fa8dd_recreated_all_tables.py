...
Revision ID: d23c379fa8dd
Revises: 
Create Date: 2025-02-19 19:00:15.134607
...
def upgrade():
    ...
    with op.batch_alter_table('users', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('registration_date', sa.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=True))
